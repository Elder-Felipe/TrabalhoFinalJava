...
public class Trabalho_Final {
    ...
    public static void main(String[] args) {
        ...
        do { //LOOP DE REPETIÇÃO DE TODOS OS SWITCH, DA UMA SEGUNDA CHANCE PARA OS USUARIOS
            qual = JOptionPane.showInputDialog(null, "QUAL PROGRAMA DESEJA USA? \n \n 1.LAÇOS DE REPETIÇÃO \n 2.CALCULADORA ", "BEM VINDO", JOptionPane.INFORMATION_MESSAGE); //ENTRADA DE DADOS FUNDAMENTAL PARA A ESCOLHA DO CASE(DO PRIMEIRO SWITCH) 
                ...
                case "2":
                    ...
                    switch (qualoperador) {
                        ...
                        case "2":
                            ...
                            Metodos_Calculadora sub = new Metodos_Calculadora(); //INICIANDO O METODO DA SOMA-
                        ...
                        case "3":
                            ...
                            Metodos_Calculadora div = new Metodos_Calculadora(); //INICIANDO O METODO DA SOMA-
